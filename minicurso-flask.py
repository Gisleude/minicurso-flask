...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/suporte_npiti/Documentos/minicursoPython/flask-minicurso/pokemons.db'
db = SQLAlchemy(app)
...
def play():
    ...
    return render_template('game.html', opts=opts, ataques=ataques, current_player=current_player.nome, q_players = len(players))
